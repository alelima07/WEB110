...
<html lang="en">
 <head>
     <title>Web Developer Examples and Resources by Alessandra</title>
  <meta charset="utf-8" />
 ...
 <body>
     <main>
     <header>
        <h1><a href="index.html">Web Developer Examples and Resources by Alessandra</a></h1>
        <nav id="cssmenu">
          <ul>
     ...
     <footer>
      <p><small>&copy; 2020 by <a href="contact.php">Alessandra Lima</a>. All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </main>
